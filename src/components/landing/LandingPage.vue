...
import ProductCarousel from '@/components/landing/ProductCarousel.vue'
...
import type { Product, LandingTestimonial, LandingServiceItem } from '@/types/database'
...
<template>
  <ApplicationLayout show-staff-button>
    <div class="w-full">
      ...
      <!-- Carousel -->
      <section v-if="carouselEnabled" class="px-6 py-20" :style="{ backgroundColor: carouselBgColor }">
        <ProductCarousel
          :products="products"
      ...
      <!-- Testimonials -->
      <section v-if="testimonialsEnabled" class="px-6 py-20" :style="{ backgroundColor: testimonialsBgColor }">
        <TestimonialsSection
      ...
      <!-- Services -->
      <section v-if="servicesEnabled" class="px-6 py-20" :style="{ backgroundColor: servicesBgColor }">
        <ServicesSection
          :items="servicesData ?? []"
          :accent-color="primaryColor"
          :title="servicesTitle"
      ...
      <!-- Gallery -->
      <section v-if="galleryEnabled" class="px-6 py-20" :style="{ backgroundColor: galleryBgColor }">
        <GallerySection
      ...
      <!-- Contact -->
      <section v-if="contactEnabled" class="px-6 py-20" :style="{ backgroundColor: contactBgColor }">
        <ContactSection
          :accent-color="primaryColor"
          :title="contactTitle"
