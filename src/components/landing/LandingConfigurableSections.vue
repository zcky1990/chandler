...
const carouselStyle = computed(() => landingSectionStyle(props.carouselBgImage, props.carouselBgColor))
...
<template>
  <section v-if="carouselEnabled" class="px-6 py-20" :style="carouselStyle">
    <ProductCarousel
      :products="products"
  ...
  <section v-if="contactEnabled" class="px-6 py-20" :style="contactStyle">
    <ContactSection
      :accent-color="primaryColor"
      :title="contactTitle"
