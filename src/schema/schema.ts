...
export function shopConfigSchema() {
  return z.object({
    ...
    landing_carousel_bg_image_url: z.string().nullable().optional(),
    ...
    landing_testimonials_bg_image_url: z.string().nullable().optional(),
    ...
    landing_services_bg_image_url: z.string().nullable().optional(),
    ...
    landing_gallery_bg_image_url: z.string().nullable().optional(),
    ...
    landing_contact_bg_image_url: z.string().nullable().optional(),
    landing_about_enabled: z.boolean().optional(),
    landing_about_label: z.string().nullable().optional(),
    landing_about_title: z.string().nullable().optional(),
    landing_about_description: z.string().nullable().optional(),
    landing_about_image_url: z.string().nullable().optional(),
    landing_about_bullets: z.any().nullable().optional(),
    landing_about_bg_color: z.string().optional(),
    landing_why_enabled: z.boolean().optional(),
    landing_why_label: z.string().nullable().optional(),
    landing_why_title: z.string().nullable().optional(),
    landing_why_description: z.string().nullable().optional(),
    landing_why_features: z.any().nullable().optional(),
    landing_why_stats: z.any().nullable().optional(),
    landing_why_bg_color: z.string().optional(),
    landing_hero_bg_color: z.string().optional(),
    landing_hero_bg_image: z.string().nullable().optional(),
    landing_about_bg_image: z.string().nullable().optional(),
    landing_why_bg_image: z.string().nullable().optional(),
    landing_carousel_bg_image: z.string().nullable().optional(),
    landing_testimonials_bg_image: z.string().nullable().optional(),
    landing_services_bg_image: z.string().nullable().optional(),
    landing_gallery_bg_image: z.string().nullable().optional(),
